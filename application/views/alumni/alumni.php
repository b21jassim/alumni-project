    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3">Alumni Login
      </h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Alumni Login</li>
      </ol>
      ...
      <div class="row">
        <div class="col-lg-8 mb-4">
          ...
          <?php } ?>
          <h3>Register Here ...</h3>
          <form name="sentMessage" id="contactForm" method="post" action="<?=base_url()?>home/register">
